...
<title>Add Q | Personality Pulse</title>
<style>
...
<div style="font-size: 2.0rem; color: #035053; margin-bottom: 2rem;">
  ...
  <h4><span class="emoji">🎉🔧</span> Add a fresh question to the mix <span class="emoji">🎉🔧</span></h4>



  <div class="form-box">
    <form action="addQ" method="post">
      <label for="question">Enter your Q:</label>
      <textarea id="question" name="qtext" rows="3" required></textarea>
