...
<title>Edit Q | Personality Pulse</title>
<style>
...
<div style="font-size: 2.0rem; color: #035053; margin-bottom: 2rem;">
  ...
  <h4>
  <span class="emoji">🔧✨</span> Let’s give this question a glow-up <span class="emoji">🔧✨</span>
</h4>
  ...
  <div class="form-box">
    <form action="updateQuestion" method="post">
      ...
      <textarea id="qtext" name="qtext" rows="3" required>${question.qtext}</textarea>

      <label for="opta">Option A:</label>
      <input type="text" id="opta" name="opta" value="${question.opta}" required />

      <label for="optb">Option B:</label>
      <input type="text" id="optb" name="optb" value="${question.optb}" required />

      <label for="optc">Option C:</label>
      <input type="text" id="optc" name="optc" value="${question.optc}" required />
